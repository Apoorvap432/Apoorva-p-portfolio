      ...
      <div className="relative min-h-screen flex items-center justify-center flex-col">
        ...
        <div className="max-w-xl relative z-10 sm:px-10 px-5 mt-12">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col space-y-7">
            ...
            <button className="bg-black-500 px-5 py-2 min-h-12 rounded-lg shadow-black-200 shadow-2xl flex justify-center items-center text-lg text-white gap-3" type="submit" disabled={loading}>
              {loading ? 'Sending...' : 'Send Message'}

              <img src="/assets/arrow-up.png" alt="arrow-up" className="bg-black-500 px-5 py-2 min-h-12 rounded-lg shadow-black-200 shadow-2xl flex justify-center items-center text-lg text-white gap-3_arrow" />
            </button>
          </form>
        </div>
      </div>
